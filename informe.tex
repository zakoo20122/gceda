...
\begin{center}
  \begin{tabular}{ | l | c | c | c | }
    ...
    $K_{20}$ & 2ms & 27ms & 3ms \\ \hline
    $C_{20}$ & 0ms & 9ms & 3668ms \\ \hline
...
\par
Si bien la solución del algoritmo de Tabu Search parte del Greedy e intenta mejorarlo, no siempre un Tabu Search va a dar menor coloreo que un Greedy (ejecutando uno despues del otro) ya que el Greedy usa un coloreo con aletoreidad que hace que la solución varíe para un mismo grafo.
